...
export const metadata: Metadata = {
  ...
  description:
    'Listen to anointed audio sermons from General Overseer Pst. Gabriel Emmanuel, Pst. Balogun Adebayo, Pst (Mrs) Gabriel Emmanuel, and Lady Evang. Oyedele. Stream online and download MP3 audio messages.',
  keywords: [
  ...
  openGraph: {
    ...
    url: 'https://praise-website-azure.vercel.app/sermons',
    images: [{ url: '/images/og-image.jpg', alt: 'Sermons Media Hub' }],
  },
};
